...
lead: "การวิเคราะห์โดยใช้กฎเคอร์ชอฟฟมีข้อเสียในกรณีที่วงจรมีขนาดใหญ่ ทำให้การวิเคราะห์ใช้เวลามาก เพื่อแก้ปัญหาดังกล่าว ทฤษฏีวงจรได้ถูกคิดค้นเพื่อเป็นเครื่องมือในการหาคำตอบ
...
ตัวอย่างเช่นตัวต้านทาน จากกฎโอห์ม อินพุท $i$ สัมพันธ์กับเอาท์พุท $v$ ดังนี้
$$
\begin{equation}
    v=iR    \tag{4.1}
\end{equation}
$$
ถ้ากำหนดให้อินพุทเดิมเป็น $i_{old}$ จากกฎโอห์ม เอาท์พุทเดิม $v_{old}$ คือ
$$
\begin{equation}
