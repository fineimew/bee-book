...
ขนาดของกำลังเชิงซ้อน $\mathbf{S}$ คือกำลังปรากฎ $S$ ดังนั้นหน่วยวัดกำลังเชิงซ้อนคือ volt-amperes (VA)
...
| กำลังปรากฎ   | $ S=\|\mathbf{S}\|=\|\mathbf{V}\_\text{rms}\|\|\mathbf{I}\_\text{rms}\|=\sqrt{P^2+Q^2}$ |
...
สามเหลี่ยมกำลังในรูปที่ 7.9(a) แสดงความสัมพันธ์ระหว่าง กำลังเชิงซ้อน $\mathbf{S}$ (หรือกำลังปรากฎ $S$) กำลังจริง $P$ กำลังรีแอคทีฟ $Q$ และมุมตัวประกอบกำลัง โดยที่ถ้าทราบสองค่า จะหาอีกสองค่าที่เหลือได้ เช่นถ้าทราบมุมตัวประกอบกำลัง กับ กำลังรีแอคทีฟ ก็จะสามารถหา กำลังปรากฎ กับ กำลังจริงได้ ซึ่งสามเหลี่ยมกำลังจะมีลักษณะคล้ายกับสามเหลี่ยมอิมพีแดนซ์ในรูปที่ 7.9(b) ซึ่งถ้าทราบค่า $R$ กับ $X$ ก็สามารถหาขนาดอิมพีแดนซ์ $|\mathbf{Z}|$ และมุมของอิมพีแดนซ์ $\theta$ ได้
...
\end{align*}
และโจทย์ให้ค่ากำลังปรากฎคือ $S=12,000\\;\mathrm{VA}$ ดังนั้นกำลังจริง $P$ คือ
\begin{align*}
