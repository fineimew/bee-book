...
\end{equation}
$$
$v_1$ และ $v_2$ มีเฟสไม่ตรงกัน (out of phase) เมื่อ $\phi \neq 0$
...
ตัวอย่าง 5.1 จงหา ขนาด เฟส คาบ และความถี่ของสัญญาณ
\begin{equation*}
...
ตัวอย่าง 5.2 จงหามุมเฟสระหว่าง $v_1=-10\cos (\omega t + 50^{\circ})$ และ $v_2=12 \sin (\omega t - 10^{\circ})$
