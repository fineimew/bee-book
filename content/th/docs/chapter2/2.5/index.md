...
ตัวอย่าง 2.5 จงหา $v_o$ และ $i_o$ และให้คำนวณกำลังที่ใช้โดยตัวต้านทาน $3\Omega$
...
ตัวอย่าง 2.6 จงหา $v_o$  และ กำลังที่แหล่งจ่ายกระแสจ่าย และกำลังที่ตัวต้านทานแต่ละตัวใช้
