...
{{< admonition info "นิยาม 2.3 กฏกระแสเคอร์ชอฟ" false>}}
...
กฏแรงดันเคอร์ชอฟมาจากกฏอนุรักษ์พลังงาน

{{< admonition info "นิยาม 2.4 กฏแรงดันเคอร์ชอฟ" false>}}
กฏแรงดันเคอร์ชอฟ (Kirchoff's Voltage Law) 
...
<p align="center">
  ...
  <figcaption style='text-align:center'>รูปที่ 2.9 รูปวงจรสำหรับการใช้กฏ KVL</figcaption>
</figure>
...
<p align="center">
  ...
  <figcaption style='text-align:center'>รูปที่ 2.10 รูปวงจรสำหรับการใช้กฏ KVL ในการรวมแหล่งจ่ายแรงดัน</figcaption>
</figure>
...
กำหนดให้กระแสหมุนตามเข็มนาฬิกา ใช้กฏของโอห์มหาแรงดัน $v_1$ และ $v_2$ 
$$
\begin{equation} 
v_1 = 2i\\:,\\:\\: v_2 = -3i    \tag{2.21}
\end{equation}
$$
จากนั้นใช้กฏ KVL ได้สมการ
$$
\begin{equation}
...
แทนค่าแรงดัน $v_1 \text{และ}\:v_2 $จากกฏของโอห์ม
...
กำหนดให้กระแสหมุนตามเข็มนาฬิกา ใช้กฏของโอห์มหาแรงดัน $v_1$  $v_2$ และ $v_3$ 
$$
